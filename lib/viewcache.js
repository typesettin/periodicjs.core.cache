...
ViewCache.prototype.get = function(options,asyncCallback){
	try{
		...
		ViewCache.prototype.length({},function(e,num){
			// console.log('ViewCache get length',num);
		})
	}
	catch(e){
		asyncCallback(e);
...
ViewCache.prototype.set = function(options,asyncCallback){
	try{
		...
		ViewCache.prototype.length({},function(e,num){
			// console.log('ViewCache set length',num);
		})
	}
	catch(e){
		asyncCallback(e);
...
ViewCache.prototype.del = function(options,asyncCallback){
	try{
		...
		ViewCache.prototype.length({},function(e,num){
			// console.log('ViewCache del length',num);
		})
	}
	catch(e){
		asyncCallback(e);
...
ViewCache.prototype.size = function(options,asyncCallback){
	try{
		...
		ViewCache.prototype.length({},function(e,num){
			// console.log('ViewCache size length',num);
		})
	}
	catch(e){
		asyncCallback(e);
...
ViewCache.prototype.clearCache = function(options,asyncCallback){
	try{
		...
		ViewCache.prototype.length({},function(e,num){
			// console.log('ViewCache clearCache length',num);
		})
	}
	catch(e){
		asyncCallback(e);
