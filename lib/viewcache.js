...
var fs = require('fs-extra'),
	path = require('path'),
	du = require('du'),
	viewCacheDir = path.resolve(process.cwd(),'cache');
...
var ViewCache = function (options) {
	this.type='flatfile';
	this.driver = 'fs';
	this.expires = (options && options.expires) ? options.expires : 3600;
	viewCacheDir = (options && options.viewCacheDir) ? options.viewCacheDir : viewCacheDir;
...
//Deletes all keys
ViewCache.prototype.clear = function(options,asyncCallback){
	try{
